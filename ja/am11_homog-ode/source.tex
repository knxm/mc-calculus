...
\AMCcodeVspace=0em
\luaexec{math.randomseed(190619)} % \onecopy{} の外に配置
...
\onecopy{1}{
%%% ヘッダー開始: %%%   
\noindent{\textbf{応用数学 演習11 \hfill 2019年6月19日}}
...
%%% ヘッダー終了 %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{question}{hode01}
微分方程式 \(\displaystyle\frac{dx}{dt} = \frac{x}{t}+\cos^{2}\frac{x}{t}\) の一般解を求めなさい．

\AMCOpen{lines=4, dots=false, framerule=0pt}{\wrongchoice[W]{誤}\scoring{0}\wrongchoice[P]{部}\scoring{1}\correctchoice[C]{正}\scoring{2}}
\end{question}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{question}{hode02}
微分方程式 \(\displaystyle\frac{dx}{dt} = \frac{t^2+tx+x^2}{t^2}\) の一般解を求めなさい．
