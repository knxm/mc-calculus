...
\AMCcodeVspace=0em
\luaexec{math.randomseed(190626)} % \onecopy{} の外に配置
...
\onecopy{2}{
%%% ヘッダー開始: %%%   
\noindent{\textbf{応用数学 演習09 \hfill 2022年6月15日}}
...
微分方程式 \(\, \displaystyle t\frac{dx}{dt} - x = \var{formula}\) の一般解を求めなさい．
